...
const translator = createTranslator('perseusInternalMessages', {
  ...
  "You must turn on all of the lights to continue.": "You must turn on all of the lights to continue.",
  "Make sure you fill in all cells in the matrix.": "Make sure you fill in all cells in the matrix.",
  ...
  "reflection": "reflection",
  "Reflection over the line from { point1 } to { point2 }": "Reflection over the line from { point1 } to { point2 }",
  "Dilate": "Dilate",
  "Dilation": "Dilation",
  "dilation": "dilation",
  ...
  "Fraction, with current expression in numerator": "Fraction, with current expression in numerator",
  ...
  "Navigate right into the numerator of a fraction": "Navigate right into the numerator of a fraction",
  "Navigate right out of the numerator and into the denominator": "Navigate right out of the numerator and into the denominator",
  "Navigate right out of the denominator of a fraction": "Navigate right out of the denominator of a fraction",
  "Delete": "Delete",
  "Dismiss": "Dismiss",
